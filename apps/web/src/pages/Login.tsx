...
import { Button, Card, CardContent, CardHeader, Input, Label } from '@demp/ui';
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-6 sm:space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs sm:text-sm text-white/30 font-medium">Department Event Management Portal</p>
        </div>
        <Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input id="password" type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required className="pr-11" />
              ...
              <p className="text-center text-sm text-white/30 font-medium">
                No account?{' '}
                <Link to="/register" className="text-primary-300 hover:text-primary-200">Sign up</Link>
              </p>
            </form>
          </CardContent>
        </Card>
